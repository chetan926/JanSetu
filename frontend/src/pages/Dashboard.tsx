  ...
  return (
    <div className="w-full px-4 sm:px-6 lg:px-8 pt-6 pb-12">
      <div className="mx-auto w-full max-w-7xl space-y-8">
        ...
        {/* Header Banner */}
        <div className="relative overflow-hidden rounded-3xl border border-amber-200/80 bg-gradient-to-r from-amber-50/90 via-white to-amber-50/50 p-6 sm:p-8 lg:p-10 shadow-sm backdrop-blur-xl">
          <div className="relative z-10 w-full max-w-2xl space-y-3">
            ...
            <div className="pt-2 flex flex-wrap gap-3">
              <Button
                ...
                className="bg-[#FF9933] text-[#0F172A] hover:bg-[#E69500] font-bold shadow-md"
              >
                Apply for Scholarship <ArrowRight className="ml-2 h-4 w-4" />
              </Button>
              <Button
                onClick={() => navigate('user/interop')}
                variant="outline"
                className="border-slate-300 text-[#0F172A] hover:bg-slate-100 font-semibold"
              >
        ...
        {/* Quick Action Grid */}
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 sm:gap-5 lg:gap-6 items-stretch">

          <GlassCard
            onClick={() => setIsWizardOpen(true)}
            className="cursor-pointer h-full flex flex-col p-6"
          >
            ...
            <p className="mt-1 text-xs text-slate-600 flex-1">
              Discover scholarships & welfare schemes using AI assistant.
            </p>
          </GlassCard>
          ...
          >
            ...
            <p className="mt-1 text-xs text-slate-600 flex-1">
              Control data sharing permissions for government departments.
            </p>
          </GlassCard>
          ...
          >
            ...
            <p className="mt-1 text-xs text-slate-600 flex-1">
              Track digital application timeline & audit trace history.
            </p>
          </GlassCard>
          ...
          >
            ...
            <p className="mt-1 text-xs text-slate-600 flex-1">
              Inspect schema mapping, canonical models & live API logs.
            </p>
          </GlassCard>
